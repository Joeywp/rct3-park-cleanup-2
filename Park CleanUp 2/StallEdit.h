...
namespace ParkCleanUp2 { 
	...
	/// <summary>
	/// Summary for StallEdit
	/// </summary>
	public ref class StallEdit : public System::Windows::Forms::Form
	{
		ref class Form1;
	public:
		StallEdit(void)
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_save->Text = L"Mark stall for removal";
			this->btn_save->UseVisualStyleBackColor = true;
			this->btn_save->Click += gcnew System::EventHandler(this, &StallEdit::button1_Click);
			// 
			// btn_cancel
			// 
			...
			this->btn_cancel->Click += gcnew System::EventHandler(this, &StallEdit::button2_Click);
			// 
			// track_resolver
			// 
			this->track_resolver->DoWork += gcnew System::ComponentModel::DoWorkEventHandler(this, &StallEdit::track_resolver_DoWork);
			// 
			// prog
			// 
			...
			this->Name = L"StallEdit";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Stall options";
			this->Load += gcnew System::EventHandler(this, &StallEdit::StallEdit_Load);
...
#pragma endregion
	...
	private: System::Void track_resolver_DoWork(System::Object^  sender, System::ComponentModel::DoWorkEventArgs^  e) {
				 ...
				 findList.push_back("ShopExtra");
				 findList.push_back("ShopItem");
	...
	private: System::Void StallEdit_Load(System::Object^  sender, System::EventArgs^  e) {
